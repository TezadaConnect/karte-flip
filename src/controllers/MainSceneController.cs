...
public partial class MainSceneController : Node {
	...
	public override void _Ready(){
		...
		InitUiBindings();
		InitializeListeners();
		_turnRpcService = GetNode<TurnRpcService>(mRouteManager.GetSingletonAutoLoad(SingletonAutoLoadEnum.TURN_RPC_SERVICE));
	...
	private void OnTapGroundTile(InputEvent @event){
		...
		_turnRpcService.ExecuteAddTokenToTilemap(tilePostion, TileHelper.GetRandomCard());
